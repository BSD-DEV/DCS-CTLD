...
ctld.loadableGroupsbyType['Mi-8MT'] = {
                        {name = "Standard Group", inf = 16, mg = 4, at = 4 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
                        {name = "Infantry Only", inf = 18, mg = 6  },
